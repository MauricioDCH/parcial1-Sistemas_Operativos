// Archivo: permutations_arrays-substitutions_boxes.cpp

#include "permutations_arrays-substitutions_boxes.h"

const std::array<DWORD, NUMERO_DE_PERMUTACIONES> BLOWFISH_PERMUTATIONS_ARRAY = {
...
const std::array<std::array<DWORD, NUMERO_DE_ELEMENTOS_POR_CAJA>, NUMERO_DE_CAJAS>BLOWFISH_SUBSTITUTIONS_BOXES = {
    {
        {
